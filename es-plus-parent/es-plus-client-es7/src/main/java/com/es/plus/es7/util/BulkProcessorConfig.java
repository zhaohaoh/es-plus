...
public class BulkProcessorConfig {
    ...
    public static BulkProcessor getBulkProcessor(Object restHighLevelClient,String index) {
        BulkProcessor bulkProcessor = bulkProcessorMap.computeIfAbsent(index,
                a -> {
                    ...
                    BulkProcessor processor = doGetBulkProcessor((RestHighLevelClient) restHighLevelClient,bulkProcessorParam);
                    return processor;
                });
