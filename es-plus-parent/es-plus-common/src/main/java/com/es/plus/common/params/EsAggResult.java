...
//    }
    ...
    public Long getCount(SFunction<T,?> aggName) {
        ...
        Long result = countMap.get(getAggregationField(aggName)+ EsConstant.AGG_DELIMITER + "value_count");
        return result;
    }
    ...
    public Double getSum(SFunction<T,?> aggName) {
        ...
        Double result = sumMap.get(getAggregationField(aggName)+ EsConstant.AGG_DELIMITER + "sum");
        return result;
    }
    ...
    public Double getMax(SFunction<T,?> aggName) {
        ...
        Double result = maxMap.get(getAggregationField(aggName)+ EsConstant.AGG_DELIMITER + "max");
        return result;
    }
    ...
    public Double getMin(SFunction<T,?> aggName) {
        ...
        Double result = minMap.get(getAggregationField(aggName)+ EsConstant.AGG_DELIMITER + "min");
        return result;
    }
    ...
    public Double getAvg(SFunction<T,?> aggName) {
        ...
        Double result = avgMap.get(getAggregationField(aggName)+ EsConstant.AGG_DELIMITER + "avg");
        return result;
    }
