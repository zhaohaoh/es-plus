...
public class EpAggregationConvert {
    ...
    public static BaseAggregationBuilder toEsAggregationBuilder(EpAggBuilder customAgg) {
        ...
        switch (type) {
            ...
            case "count":
                ValueCountAggregationBuilder countAgg = new ValueCountAggregationBuilder(name,null);
                if (params.containsKey("field")) {
            ...
            case "cardinality":
                CardinalityAggregationBuilder cardinalityAgg = new CardinalityAggregationBuilder(name,null);
                if (params.containsKey("field")) {
            ...
            case "missing":
                MissingAggregationBuilder missingAgg = new MissingAggregationBuilder(name,null);
                if (params.containsKey("field")) {
            ...
            case "date_histogram":
                ...
                if (params.containsKey("interval")) {
                    //TODO 下次改
                    EpDateHistogramInterval interval = (EpDateHistogramInterval) params.get("interval");
//                    dateHistogramAgg.interval(Duration.valueOf(interval.getExpression()));
                }
            ...
            case "significant_terms":
                SignificantTermsAggregationBuilder significantTermsAgg = new SignificantTermsAggregationBuilder(name,null);
                if (params.containsKey("field")) {
