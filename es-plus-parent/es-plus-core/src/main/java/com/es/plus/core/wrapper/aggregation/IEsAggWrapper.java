...
public interface IEsAggWrapper<Children, R,T>  {
     ...
     */
    default  Children add(BaseAggregationBuilder baseAggregationBuilder){
        return add(baseAggregationBuilder);
    };
    /**
     * 统计
     *
     ...
     */
     default Children filters(R field, FiltersAggregator.KeyedFilter... filters){
       return   filters(null,  field,filters);
     };
...
//       return   adjacencyMatrix(null,  field,separator,adjacencyMatrixMap);
//     };
    ...
    default Children bucketScript(R field, Script script, String... bucketsPaths){
       return   bucketScript(null,  field,script,bucketsPaths);
     };
...
//    ==============================================================
    ...
    default Children filters(String name,R field, FiltersAggregator.KeyedFilter... filters){
        return   filters(name,  field,filters);
    };
