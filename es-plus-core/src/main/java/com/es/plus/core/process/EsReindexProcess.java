...
public class EsReindexProcess {
    ...
    private static void doReindex(EsPlusClientFacade esPlusClientFacade, Class<?> clazz, EsIndexParam esIndexParam,
        ...
        EsReadWriteLock readWrtieLock = esPlusClientFacade
                .getReadWrtieLock(esIndexParam.getIndex() + EsConstant.REINDEX_UPDATE_LOCK);
    ...
    private static Map<String, Object> getUpdateReindexTimeMappins(Map<String, Object> esIndexMapping) {
        Map<String, Object> mappings = new LinkedHashMap<>(
                (Map<String, Object>) esIndexMapping.get(EsConstant.PROPERTIES));
